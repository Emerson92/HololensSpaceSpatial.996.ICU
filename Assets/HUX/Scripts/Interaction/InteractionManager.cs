...
namespace HUX.Interaction
{
    public class InteractionManager : Singleton<InteractionManager>
    {
		...
		protected void Start()
        {
            ...
            UnityEngine.XR.WSA.Input.InteractionManager.InteractionSourcePressed += InteractionSourcePressedHandle;//+= InteractionManager_SourcePressedCallback;

            UnityEngine.XR.WSA.Input.InteractionManager.InteractionSourceReleased+= InteractionSourceReleasedHandle;//+= InteractionManager_SourceReleasedCallback;
            bLockFocus = true;
		}

        private void InteractionSourceReleasedHandle(InteractionSourceReleasedEventArgs obj)
        {
            AFocuser focuser = GetFocuserForSource(obj.state.source.kind);
            OnReleasedEvent(focuser);
        }

        private void InteractionSourcePressedHandle(InteractionSourcePressedEventArgs obj)
        {
            AFocuser focuser = GetFocuserForSource(obj.state.source.kind);
